    ...
    const links = <>
        ...
        <li><NavLink to="/register">Register</NavLink></li>
        {
            user && <>
                ...
                <li><NavLink to="/add-food">My Foods</NavLink></li>
    ...
    return (
        <div className="navbar  shadow-sm max-w-7xl mx-auto px-4">
            <div className="navbar-start">
                ...
                <Link to="/" className="btn btn-ghost text-xl font-extrabold text-gray-900 hover:bg-transparent">
                    <span className="text-orange-500 text-3xl">🍽️</span> PlateShare
                </Link>
            </div>
